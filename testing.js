...
function initGameLoop() {
  ...
  // unexploredDirs are empty (no unexplored exits) but can reverse route (backwardsPath has length)
  ...
  // ---> No Dead End found yet <-----
    ...
    var nextMove = unexploredDirs[0];
    unexploredDirs = [];

    // Record backwards version of move and push to backwardsPath array
    var backwardsMove = oppositeDirection(nextMove);
